...
<tr><td>Begin timestamp:</td><td><input type="number" name="begin_timestamp"/> (Unix time)</td></tr>
<tr><td>End timestamp:</td><td><input type="number" name="end_timestamp"/> (Unix time)</td></tr>
